...
static obs_properties_t *virtual_filter_properties(void *data)
{
	...
	obs_property_list_add_int(cb, "NNK-Camera", ModeVideo);
	obs_property_list_add_int(cb, "NNK-Camera2", ModeVideo2);
	obs_property_list_add_int(cb, "NNK-Camera3", ModeVideo3);
	obs_property_list_add_int(cb, "NNK-Camera4", ModeVideo4);
