	  ...
	  ui(new Ui::VirtualProperties)
{
	...
	ui->comboBox_target->addItem("NNK-Camera", ModeVideo);
	ui->comboBox_target->addItem("NNK-Camera2", ModeVideo2);
	ui->comboBox_target->addItem("NNK-Camera3", ModeVideo3);
	ui->comboBox_target->addItem("NNK-Camera4", ModeVideo4);
